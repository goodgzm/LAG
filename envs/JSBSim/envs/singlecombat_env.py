...
from ..human_task.HumanSingleCombatShootTask import HumanSingleCombatShootTask
...
class SingleCombatEnv(BaseEnv):
    ...
    def load_task(self):
        ...
        elif taskname == 'HumanSingleCombatShoot':
            self.task = HumanSingleCombatShootTask(self.config)
        else:
